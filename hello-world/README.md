...
- A portal with JS Building Blocks enabled. To turn on JS Building Blocks, go to [https://app.hubspot.com/design-manager/<YOUR_PORTAL_ID>/settings](https://app.hubspot.com/design-manager/<YOUR_PORTAL_ID>/settings) and opt-in.  
